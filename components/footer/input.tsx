...
export type OmittedTypes = 'size' | 'required' | 'checked' | 'defaultChecked'
  ...
  (
    ...
    return (
      <input
        ...
        aria-describedby={ariaDescribedby}
        className={cx(
          'appearance-none relative w-full block bg-white/30 outline-none',
          'rounded-md py-3 px-4',
          'text-sm text-white placeholder:text-gray-300',
          'focus:outline-none focus:ring-0 focus:shadow-none',
          'transition-all',
          {
            'border-gray-400 focus:border-blue-400': !valid && !invalid,
